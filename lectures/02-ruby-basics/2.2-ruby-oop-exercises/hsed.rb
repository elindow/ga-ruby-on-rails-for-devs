...
=begin
	...
	sum = nhs.inject(0)  do | sum, (key, value) |	#this will 'inject' sum with previous value of sum and operation defined by block
		...
		return sum
=end
	#minimalist version that replaces original rhs with difference of each point (assuming that's lega;), could just as easily replace lhs by flipping the vars
